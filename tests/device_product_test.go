...
func TestDeviceProductDetail(t *testing.T) {
	...
	product.Value("image").String().Equal("http://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	...
	product.Value("sliderImage").String().Equal("http://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg,http://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	product.Value("sliderImages").Array().First().String().Equal("http://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	product.Value("sliderImages").Array().Last().String().Equal("http://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	...
	attrValue.Element(0).Object().Value("image").String().Equal("\thttp://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	...
	attrValue.Element(1).Object().Value("image").String().Equal("\thttp://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	...
	attrValue.Element(2).Object().Value("image").String().Equal("\thttp://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
	...
	attrValue.Element(3).Object().Value("image").String().Equal("\thttp://127.0.0.1:8090/uploads/def/20200816/9a6a2e1231fb19517ed1de71206a0657.jpg")
