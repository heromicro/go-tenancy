...
var configs = []model.SysConfig{
	...
	{SysConfigCategoryID: 7, ConfigName: "空间域名 Domain", ConfigKey: "bucket_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "accessKey", ConfigKey: "access_key_id", ConfigType: "input", ConfigRule: "", Required: 2, Info: "accessKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "secretKey", ConfigKey: "access_key_secret", ConfigType: "input", ConfigRule: "", Required: 2, Info: "secretKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "存储空间名称", ConfigKey: "bucket_name", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "endpoint", ConfigKey: "endpoint", ConfigType: "input", ConfigRule: "", Required: 2, Info: "endpoint", Sort: 0, UserType: 2, Status: 1},
	...
	{SysConfigCategoryID: 8, ConfigName: "空间域名 Domain", ConfigKey: "bucket_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "access_key", ConfigKey: "qiniu_accessKey", ConfigType: "input", ConfigRule: "", Required: 2, Info: "accessKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "secret_key", ConfigKey: "qiniu_secretKey", ConfigType: "input", ConfigRule: "", Required: 2, Info: "secretKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "存储空间名称", ConfigKey: "bucket", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "所属地域", ConfigKey: "zone", ConfigType: "input", ConfigRule: "", Required: 2, Info: "所属地域", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "空间域名 Domain", ConfigKey: "base_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	...
	{SysConfigCategoryID: 9, ConfigName: "存储空间名称", ConfigKey: "bucket", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "所属地域", ConfigKey: "region", ConfigType: "input", ConfigRule: "", Required: 2, Info: "所属地域", Sort: 0, UserType: 2, Status: 1},
