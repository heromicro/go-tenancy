...
var configs = []model.SysConfig{
	...
	{SysConfigCategoryID: 1, ConfigName: "商户管理员默认密码", ConfigKey: "tenancy_admin_password", ConfigType: "input", ConfigRule: "", Required: 2, Info: "商户管理员默认密码", Sort: 0, UserType: 2, Status: 1},
	...
	{SysConfigCategoryID: 5, ConfigName: "银行卡开户行", ConfigKey: "bank", ConfigType: "input", ConfigRule: "", Required: 1, Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "银行卡卡号", ConfigKey: "bank_number", ConfigType: "input", ConfigRule: "", Required: 1, Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "银行卡持卡人姓名", ConfigKey: "bank_name", ConfigType: "input", ConfigRule: "", Required: 1, Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "银行卡开户行地址", ConfigKey: "bank_address", ConfigType: "input", ConfigRule: "", Required: 1, Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 1, ConfigName: "快递查询密钥", ConfigKey: "express_app_code", ConfigType: "input", ConfigRule: "", Required: 2, Info: "阿里云快递查询接口密钥购买地址：https://market.aliyun.com/products/56928004/cmapi021863.html", Sort: 0, UserType: 2, Status: 2},
	{SysConfigCategoryID: 7, ConfigName: "空间域名 Domain", ConfigKey: "aliyun_bucket_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "accessKey", ConfigKey: "aliyun_access_key_id", ConfigType: "input", ConfigRule: "", Required: 2, Info: "accessKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "secretKey", ConfigKey: "aliyun_access_key_secret", ConfigType: "input", ConfigRule: "", Required: 2, Info: "secretKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "存储空间名称", ConfigKey: "aliyun_bucket_name", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 7, ConfigName: "endpoint", ConfigKey: "aliyun_endpoint", ConfigType: "input", ConfigRule: "", Required: 2, Info: "endpoint", Sort: 0, UserType: 2, Status: 1},
	...
	{SysConfigCategoryID: 8, ConfigName: "空间域名 Domain", ConfigKey: "qiniu_bucket_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "access_key", ConfigKey: "qiniu_access_key", ConfigType: "input", ConfigRule: "", Required: 2, Info: "accessKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "secret_key", ConfigKey: "qiniu_secret_key", ConfigType: "input", ConfigRule: "", Required: 2, Info: "secretKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "存储空间名称", ConfigKey: "qiniu_bucket", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 8, ConfigName: "所属地域", ConfigKey: "qiniu_zone", ConfigType: "input", ConfigRule: "", Required: 2, Info: "所属地域", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "空间域名 Domain", ConfigKey: "tengxun_base_url", ConfigType: "input", ConfigRule: "", Required: 2, Info: "空间域名 Domain", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "secretKey", ConfigKey: "tengxun_secret_key", ConfigType: "input", ConfigRule: "", Required: 2, Info: "secretKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "accessKey", ConfigKey: "tengxun_access_key", ConfigType: "input", ConfigRule: "", Required: 2, Info: "accessKey", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "存储空间名称", ConfigKey: "tengxun_bucket", ConfigType: "input", ConfigRule: "", Required: 2, Info: "存储空间名称", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 9, ConfigName: "所属地域", ConfigKey: "tengxun_region", ConfigType: "input", ConfigRule: "", Required: 2, Info: "所属地域", Sort: 0, UserType: 2, Status: 1},
	{SysConfigCategoryID: 10, ConfigName: "appId", ConfigKey: "routine_app_id", ConfigType: "input", ConfigRule: "", Required: 2, Info: "appId", Sort: 0, UserType: 2, Status: 1},
	...
	{SysConfigCategoryID: 5, ConfigName: "打印机终端号", ConfigKey: "terminal_number", ConfigType: "input", Required: 2, Info: "打印机终端号", Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "打印机应用ID", ConfigKey: "printing_client_id", ConfigType: "input", Required: 2, Info: "打印机开发者用户ID", Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "打印机用户ID", ConfigKey: "develop_id", ConfigType: "input", Required: 2, Info: "打印机的应用ID", Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "打印机密匙", ConfigKey: "printing_api_key", ConfigType: "input", Required: 2, Info: "打印机应用密匙", Sort: 0, UserType: 1, Status: 2},
	...
	{SysConfigCategoryID: 5, ConfigName: "打印机自动打印", ConfigKey: "printing_auto_status", ConfigType: "radio", ConfigRule: "	0:关闭;1:开启", Required: 2, Info: "开启后订单支付成功后自动打印", Sort: 0, UserType: 1, Status: 2},
	...
	{SysConfigCategoryID: 5, ConfigName: "打印机开启", ConfigKey: "printing_status", ConfigType: "radio", ConfigRule: "0:关闭;1:开启", Required: 2, Info: "", Sort: 0, UserType: 1, Status: 2},
	{SysConfigCategoryID: 5, ConfigName: "开启发票", ConfigKey: "mer_open_receipt", ConfigType: "radio", ConfigRule: "0:关闭;1:开启", Required: 2, Info: "设置是否开启发票", Sort: 0, UserType: 1, Status: 2},
}
