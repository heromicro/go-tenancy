...
var carbines = []gormadapter.CasbinRule{
	...
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/api/getApiById/:id", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/api/deleteApi", V2: "DELETE"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/api/updateApi/:id", V2: "PUT"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/api/getAllApis", V2: "GET"},
	...
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mini/getMiniById/:id", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mini/updateMini/:id", V2: "PUT"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mini/deleteMini/:id", V2: "DELETE"},
	...
	// MQTT
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/getCreateMqttMap", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/getUpdateMqttMap/:id", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/getMqttList", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/getMqttRecordList", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/createMqtt", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/mqtt/getMqttById/:id", V2: "GET"},
	...
	//商品分类
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/productCategory/getProductCategoryList", V2: "GET"},
	...
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/product/getProductFilter", V2: "POST"},
	...
	// 商品评论
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/productReply/replyMap", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/productReply/reply", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/productReply/deleteProductReply/:id", V2: "DELETE"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/productReply/getProductReplyList", V2: "POST"},

	//订单
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/order/getOrderList", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/order/getOrderChart", V2: "POST"},
	...
	//控制台
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/statistics/main", V2: "GET"},
	...
	{Ptype: "p", V0: TenancyAuthorityId, V1: "/v1/merchant/productCategory/getProductCategoryList", V2: "GET"},
	...
	{Ptype: "p", V0: TenancyAuthorityId, V1: "/v1/merchant/product/getProductFilter", V2: "POST"},
	...
	{Ptype: "p", V0: TenancyAuthorityId, V1: "/v1/merchant/order/getOrderChart", V2: "POST"},
	{Ptype: "p", V0: TenancyAuthorityId, V1: "/v1/merchant/order/getOrderFilter", V2: "POST"},
	...
	{Ptype: "p", V0: TenancyAuthorityId, V1: "/v1/merchant/user/changeProfile", V2: "POST"},
