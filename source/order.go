...
var groupOrders = []model.GroupOrder{
	{SysUserID: 7, GroupOrderSn: g.CreateOrderSn(model.PayTypeWx), TotalPostage: 20.00, TotalPrice: 50.00, TotalNum: 1, RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", PayPrice: 50.00, PayPostage: 30.00, Cost: 5.00, Paid: 0, PayTime: time.Now(), PayType: model.PayTypeWx, IsRemind: 1},
	{SysUserID: 7, GroupOrderSn: g.CreateOrderSn(model.PayTypeWx), TotalPostage: 1.00, TotalPrice: 88.00, TotalNum: 1, RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", PayPrice: 89.00, PayPostage: 1.00, Cost: 100.00, Paid: 0, PayType: model.PayTypeWx, IsRemind: 1, TENANCY_MODEL: g.TENANCY_MODEL{DeletedAt: gorm.DeletedAt{Time: time.Now()}}},
	{SysUserID: 7, GroupOrderSn: g.CreateOrderSn(model.PayTypeWx), TotalPostage: 1.00, TotalPrice: 88.00, TotalNum: 1, RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", PayPrice: 89.00, PayPostage: 1.00, Cost: 100.00, Paid: 1, PayType: model.PayTypeWx, IsRemind: 1},
	{SysUserID: 7, GroupOrderSn: g.CreateOrderSn(model.PayTypeWx), TotalPostage: 1.00, TotalPrice: 88.00, TotalNum: 1, RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", PayPrice: 89.00, PayPostage: 1.00, Cost: 100.00, Paid: 1, PayType: model.PayTypeWx, IsRemind: 1},
	{SysUserID: 7, GroupOrderSn: g.CreateOrderSn(model.PayTypeWx), TotalPostage: 4.00, TotalPrice: 352.00, TotalNum: 4, RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", PayPrice: 356.00, PayPostage: 4.00, Cost: 400.00, Paid: 1, PayType: model.PayTypeWx, IsRemind: 1},
}

var orders = []model.Order{
	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 1, ReconciliationID: 0, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.PayTypeWx), RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", TotalNum: 10, TotalPrice: 20.00, TotalPostage: 30.00, PayPrice: 50.00, PayPostage: 30.00, CommissionRate: 15.00, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusRefund, DeliveryType: model.DeliverTypeFH, DeliveryName: "delivery_name", DeliveryID: "delivery_id", Mark: "mark", Remark: "remark", AdminMark: "admin_mark", VerifyCode: "", VerifyTime: time.Now(), ActivityType: model.GeneralSale, Cost: 5.00, IsDel: g.StatusFalse}},
