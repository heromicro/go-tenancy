...
var orders = []model.Order{
	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 1, ReconciliationID: 0, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", TotalNum: 10, TotalPrice: 20.00, TotalPostage: 30.00, PayPrice: 50.00, PayPostage: 30.00, CommissionRate: 15.00, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusRefund, DeliveryType: model.DeliverTypeFH, DeliveryName: "delivery_name", DeliveryID: "delivery_id", Mark: "mark", Remark: "remark", AdminMark: "admin_mark", VerifyCode: "", VerifyTime: time.Now(), ActivityType: model.GeneralSale, Cost: 5.00, IsCancel: g.StatusFalse}},

	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 2, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", TotalNum: 1, TotalPrice: 88.00, TotalPostage: 1.00, PayPrice: 89.00, PayPostage: 1.00, CommissionRate: 0.2000, OrderType: model.OrderTypeGeneral, Paid: g.StatusFalse, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusNoReceive, Cost: 100.00, IsCancel: g.StatusTrue}},
	...
	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 3, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", TotalNum: 1, TotalPrice: 88.00, TotalPostage: 1.00, PayPrice: 89.00, PayPostage: 1.00, CommissionRate: 0.2000, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusNoComment, Cost: 100.00, IsCancel: g.StatusFalse}},

	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 4, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", TotalNum: 1, TotalPrice: 88.00, TotalPostage: 1.00, PayPrice: 89.00, PayPostage: 1.00, CommissionRate: 0.2000, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusFinish, Cost: 100.00, IsCancel: g.StatusFalse}},

	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 5, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "发斯蒂芬斯蒂芬", UserPhone: "13672286043", UserAddress: "北京市北京市东城区 的是非得失", TotalNum: 4, TotalPrice: 352.00, TotalPostage: 4.00, PayPrice: 356.00, PayPostage: 4.00, CommissionRate: 0.2000, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusNoDeliver, Cost: 400.00, IsCancel: g.StatusFalse}},
}
