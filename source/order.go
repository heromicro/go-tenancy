...
var groupOrders = []model.GroupOrder{
	{CUserId: 7, GroupOrderSn: g.CreateOrderSn("G"), TotalPostage: 20.00, TotalPrice: 50.00, TotalNum: 1, RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", PayPrice: 50.00, PayPostage: 30.00, Cost: 5.00, Paid: g.StatusFalse, PayTime: time.Now(), PayType: model.PayTypeWx, IsRemind: g.StatusTrue},
...
var orders = []model.Order{
	{CUserId: 7, SysTenancyId: 1, GroupOrderId: 1, ReconciliationId: 0, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.GeneralSale), RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", TotalNum: 10, TotalPrice: 20.00, TotalPostage: 30.00, PayPrice: 50.00, PayPostage: 30.00, CommissionRate: 15.00, OrderType: model.OrderTypeGeneral, Paid: g.StatusTrue, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusRefund, DeliveryType: model.DeliverTypeFH, DeliveryName: "delivery_name", DeliveryID: "delivery_id", Mark: "mark", Remark: "remark", AdminMark: "admin_mark", ActivityType: model.GeneralSale, Cost: 5.00, IsCancel: g.StatusFalse}},
