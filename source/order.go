...
var orders = []model.Order{
	{SysUserID: 7, SysTenancyID: 1, GroupOrderID: 1, ReconciliationID: 0, BaseOrder: model.BaseOrder{OrderSn: g.CreateOrderSn(model.PayTypeWx), RealName: "real_name", UserPhone: "user_phone", UserAddress: "user_address", TotalNum: 10, TotalPrice: 20.00, TotalPostage: 30.00, PayPrice: 50.00, PayPostage: 30.00, CommissionRate: 15.00, OrderType: model.OrderTypeGeneral, Paid: g.StatusFalse, PayTime: time.Now(), PayType: model.PayTypeWx, Status: model.OrderStatusRefund, DeliveryType: model.DeliverTypeFH, DeliveryName: "delivery_name", DeliveryID: "delivery_id", Mark: "mark", Remark: "remark", AdminMark: "admin_mark", VerifyCode: "", VerifyTime: time.Now(), ActivityType: model.GeneralSale, Cost: 5.00, IsDel: g.StatusFalse}},
