...
var baseApis = []model.SysApi{
	...
	{Path: "/v1/admin/user/changeUserStatus", Description: "修改状态", ApiGroup: "user", Method: "POST"},
	...
	{Path: "/v1/admin/user/getAdminList", Description: "管理员列表", ApiGroup: "user", Method: "POST"},
	...
	{Path: "/v1/admin/cuser/getGeneralDetail/:id", Description: "c用户列表", ApiGroup: "cuser", Method: "GET"},
	...
	{Path: "/v1/admin/api/getApiList", Description: "api列表", ApiGroup: "api", Method: "POST"},
	{Path: "/v1/admin/api/getApiById/:id", Description: "api详细信息", ApiGroup: "api", Method: "GET"},
	...
	{Path: "/v1/admin/api/getAllApis", Description: "所有api", ApiGroup: "api", Method: "GET"},
	...
	{Path: "/v1/admin/authority/getAuthorityList", Description: "角色列表", ApiGroup: "authority", Method: "POST"},
	...
	// 菜单管理
	{Path: "/v1/admin/menu/getMenu", Description: "菜单树", ApiGroup: "menu", Method: "GET"},
	...
	{Path: "/v1/admin/menu/getMenuList", Description: "分页基础menu列表", ApiGroup: "menu", Method: "GET"},
	...
	{Path: "/v1/admin/menu/getBaseMenuTree", Description: "用户动态路由", ApiGroup: "menu", Method: "POST"},
	{Path: "/v1/admin/menu/addMenuAuthority", Description: "增加menu和角色关联关系", ApiGroup: "menu", Method: "POST"},
	{Path: "/v1/admin/menu/getMenuAuthority", Description: "指定角色menu", ApiGroup: "menu", Method: "POST"},
	...
	{Path: "/v1/admin/menu/getBaseMenuById/:id", Description: "根据id菜单", ApiGroup: "menu", Method: "POST"},
	// 商户菜单
	{Path: "/v1/admin/menu/merchant/getClientMenuList", Description: "商户菜单", ApiGroup: "menu", Method: "GET"},

	// 多媒体文件管理
	{Path: "/v1/admin/media/getUpdateMediaMap/:id", Description: "媒体文件表单", ApiGroup: "media", Method: "GET"},
	{Path: "/v1/admin/media/upload", Description: "上传媒体文件", ApiGroup: "media", Method: "POST"},
	{Path: "/v1/admin/media/getFileList", Description: "媒体文件列表", ApiGroup: "media", Method: "POST"},
	...
	{Path: "/v1/admin/casbin/getPolicyPathByAuthorityId", Description: "权限列表", ApiGroup: "casbin", Method: "POST"},

	// 系统配置管理
	{Path: "/v1/admin/system/getSystemConfig", Description: "配置文件内容", ApiGroup: "system", Method: "POST"},
	{Path: "/v1/admin/system/setSystemConfig", Description: "设置配置文件内容", ApiGroup: "system", Method: "POST"},
	{Path: "/v1/admin/system/getServerInfo", Description: "服务器信息", ApiGroup: "system", Method: "POST"},
	// 系统配置值管理
	{Path: "/v1/admin/configValue/saveConfigValue/:category", Description: "保持配置表单", ApiGroup: "configValue", Method: "POST"},

	// 配置
	{Path: "/v1/admin/config/getUploadConfigMap", Description: "配置表单", ApiGroup: "config", Method: "GET"},
	{Path: "/v1/admin/config/getConfigMap/:category", Description: "配置表单", ApiGroup: "config", Method: "GET"},
	{Path: "/v1/admin/config/getCreateConfigMap", Description: "配置创建表单", ApiGroup: "config", Method: "GET"},
	{Path: "/v1/admin/config/getUpdateConfigMap/:id", Description: "配置编辑表单", ApiGroup: "config", Method: "GET"},
	{Path: "/v1/admin/config/getConfigList", Description: "配置项列表", ApiGroup: "config", Method: "POST"},
	{Path: "/v1/admin/config/createConfig", Description: "添加配置项", ApiGroup: "config", Method: "POST"},
	{Path: "/v1/admin/config/getConfigByKey/:key", Description: "根据key配置项", ApiGroup: "config", Method: "GET"},
	{Path: "/v1/admin/config/getConfigByID/:id", Description: "根据id配置项", ApiGroup: "config", Method: "GET"},
	...
	// 配置分类
	{Path: "/v1/admin/configCategory/getCreateConfigCategoryMap", Description: "配置分类创建表单", ApiGroup: "configCategory", Method: "GET"},
	{Path: "/v1/admin/configCategory/getUpdateConfigCategoryMap/:id", Description: "配置分类编辑表单", ApiGroup: "configCategory", Method: "GET"},
	{Path: "/v1/admin/configCategory/getConfigCategoryList", Description: "配置分类列表", ApiGroup: "configCategory", Method: "GET"},
	...
	{Path: "/v1/admin/configCategory/getConfigCategoryById/:id", Description: "配置分类", ApiGroup: "configCategory", Method: "GET"},
	...
	// 商户
	{Path: "/v1/admin/tenancy/getTenancySelect", Description: "下拉列表", ApiGroup: "tenancy", Method: "GET"},
	{Path: "/v1/admin/tenancy/changePasswordMap/:id", Description: "商户管理员编辑表单", ApiGroup: "tenancy", Method: "GET"},
	{Path: "/v1/admin/tenancy/changeCopyMap/:id", Description: "修改商品复制次数map", ApiGroup: "tenancy", Method: "GET"},
	...
	{Path: "/v1/admin/tenancy/getTenancyById/:id", Description: "商户详细信息", ApiGroup: "tenancy", Method: "GET"},
	...
	{Path: "/v1/admin/mqtt/getMqttById/:id", Description: "mqtt客户端详情", ApiGroup: "mqtt", Method: "GET"},
	...
	{Path: "/v1/admin/productCategory/getUpdateProductCategoryMap/:id", Description: "商品分类编辑表单", ApiGroup: "category", Method: "POST"},
	{Path: "/v1/admin/productCategory/getProductCategorySelect", Description: "商品分类选项", ApiGroup: "category", Method: "GET"},
	{Path: "/v1/admin/productCategory/getProductCategoryList", Description: "商品分类列表", ApiGroup: "category", Method: "POST"},
	{Path: "/v1/admin/productCategory/createProductCategory", Description: "添加商品分类", ApiGroup: "category", Method: "POST"},
	{Path: "/v1/admin/productCategory/getProductCategoryById/:id", Description: "根据id商品分类", ApiGroup: "category", Method: "GET"},
	...
	{Path: "/v1/admin/product/getProductById/:id", Description: "商品详情", ApiGroup: "product", Method: "GET"},
	{Path: "/v1/admin/product/updateProduct/:id", Description: "编辑商品", ApiGroup: "product", Method: "PUT"},
	// 商品评论
	{Path: "/v1/admin/productReply/replyMap", Description: "虚拟评论表单", ApiGroup: "productReply", Method: "GET"},
	{Path: "/v1/admin/productReply/reply", Description: "添加虚拟评论", ApiGroup: "productReply", Method: "POST"},
	{Path: "/v1/admin/productReply/deleteProductReply/:id", Description: "删除评论", ApiGroup: "productReply", Method: "DELETE"},
	{Path: "/v1/admin/productReply/getProductReplyList", Description: "商品评论列表", ApiGroup: "productReply", Method: "POST"},

	//品牌分类
	{Path: "/v1/admin/category/getCreateBrandCategoryMap", Description: "品牌分类添加表单", ApiGroup: "brandCategory", Method: "POST"},
	{Path: "/v1/admin/category/getUpdateBrandCategoryMap/:id", Description: "品牌分类编辑表单", ApiGroup: "brandCategory", Method: "POST"},
	{Path: "/v1/admin/brandCategory/getBrandCategoryList", Description: "品牌分类列表", ApiGroup: "brandCategory", Method: "GET"},
	{Path: "/v1/admin/brandCategory/createBrandCategory", Description: "添加品牌分类", ApiGroup: "brandCategory", Method: "POST"},
	{Path: "/v1/admin/brandCategory/getBrandCategoryById/:id", Description: "根据id品牌分类", ApiGroup: "brandCategory", Method: "GET"},
	...
	//品牌
	{Path: "/v1/admin/brand/getBrandList", Description: "品牌列表", ApiGroup: "brand", Method: "POST"},
	{Path: "/v1/admin/brand/getCreateBrandMap", Description: "品牌添加表单", ApiGroup: "brand", Method: "GET"},
	{Path: "/v1/admin/brand/getUpdateBrandMap/:id", Description: "品牌编辑表单", ApiGroup: "brand", Method: "GET"},
	{Path: "/v1/admin/brand/createBrand", Description: "添加品牌", ApiGroup: "brand", Method: "POST"},
	{Path: "/v1/admin/brand/getBrandById/:id", Description: "根据id品牌", ApiGroup: "brand", Method: "GET"},
	...
	// 小程序
	{Path: "/v1/admin/mini/getMiniList", Description: "小程序列表", ApiGroup: "mini", Method: "POST"},
	{Path: "/v1/admin/mini/createMini", Description: "添加小程序", ApiGroup: "mini", Method: "POST"},
	{Path: "/v1/admin/mini/getMiniById/:id", Description: "小程序详细信息", ApiGroup: "mini", Method: "GET"},
	...
	// 角色管理
	{Path: "/v1/admin/authority/getAdminAuthorityList", Description: "员工角色列表", ApiGroup: "authority", Method: "POST"},
	{Path: "/v1/admin/authority/getTenancyAuthorityList", Description: "商户角色列表", ApiGroup: "authority", Method: "POST"},
	{Path: "/v1/admin/authority/getGeneralAuthorityList", Description: "普通用户角色列表", ApiGroup: "authority", Method: "POST"},

	// 操作记录
	{Path: "/v1/admin/sysOperationRecord/getSysOperationRecordList", Description: "操作记录列表", ApiGroup: "sysOperationRecord", Method: "POST"},
	...
	// TODO:商户用户权限
	{Path: "/v1/merchant/config/getConfigMap/:category", Description: "配置表单", ApiGroup: "configClient", Method: "GET"},
	// 配置值保存
	{Path: "/v1/merchant/configValue/saveConfigValue/:category", Description: "保持配置表单", ApiGroup: "configValueClient", Method: "POST"},
	//菜单
	{Path: "/v1/merchant/menu/getMenu", Description: "菜单树", ApiGroup: "menuClient", Method: "GET"},
	// 商户
	{Path: "/v1/merchant/tenancy/getTenancyInfo", Description: "登录商户信息", ApiGroup: "tenancyClient", Method: "GET"},
	{Path: "/v1/merchant/tenancy/getUpdateTenancyMap", Description: "登录商户信息表单", ApiGroup: "tenancyClient", Method: "GET"},
	{Path: "/v1/merchant/tenancy/getTenancyCopyCount", Description: "商户商品复制次数", ApiGroup: "tenancyClient", Method: "GET"},
	{Path: "/v1/merchant/tenancy/updateTenancy/:id", Description: "保存登录商户信息", ApiGroup: "tenancyClient", Method: "PUT"},
	// 媒体库
	{Path: "/v1/merchant/media/getUpdateMediaMap/:id", Description: "媒体文件表单", ApiGroup: "mediaClient", Method: "GET"},
	...
	//品牌
	{Path: "/v1/merchant/brand/getBrandList", Description: "品牌列表", ApiGroup: "brandClient", Method: "GET"},
	//商品分类
	{Path: "/v1/merchant/productCategory/getCreateProductCategoryMap", Description: "商品分类添加表单", ApiGroup: "categoryClient", Method: "GET"},
	{Path: "/v1/merchant/productCategory/getUpdateProductCategoryMap/:id", Description: "商品分类编辑表单", ApiGroup: "categoryClient", Method: "GET"},
	{Path: "/v1/merchant/productCategory/getProductCategorySelect", Description: "商品分类选项", ApiGroup: "categoryClient", Method: "GET"},
	{Path: "/v1/merchant/productCategory/getAdminProductCategorySelect", Description: "平台商品分类选项", ApiGroup: "categoryClient", Method: "GET"},
	{Path: "/v1/merchant/productCategory/getProductCategoryList", Description: "商品分类列表", ApiGroup: "categoryClient", Method: "POST"},
	{Path: "/v1/merchant/productCategory/createProductCategory", Description: "添加商品分类", ApiGroup: "categoryClient", Method: "POST"},
	{Path: "/v1/merchant/productCategory/getProductCategoryById/:id", Description: "根据id商品分类", ApiGroup: "categoryClient", Method: "GET"},
	...
	//规格参数
	{Path: "/v1/merchant/attrTemplate/getAttrTemplateList", Description: "规格参数列表", ApiGroup: "attrTemplateClient", Method: "POST"},
	{Path: "/v1/merchant/attrTemplate/createAttrTemplate", Description: "添加规格参数", ApiGroup: "attrTemplateClient", Method: "POST"},
	{Path: "/v1/merchant/attrTemplate/getAttrTemplateById/:id", Description: "规格参数详情", ApiGroup: "attrTemplateClient", Method: "GET"},
	...
	//运费模板
	{Path: "/v1/merchant/shippingTemplate/getShippingTemplateSelect", Description: "运费模板下拉", ApiGroup: "shippingTemplateClient", Method: "GET"},
	{Path: "/v1/merchant/shippingTemplate/getShippingTemplateList", Description: "运费模板列表", ApiGroup: "shippingTemplateClient", Method: "POST"},
	{Path: "/v1/merchant/shippingTemplate/createShippingTemplate", Description: "添加运费模板", ApiGroup: "shippingTemplateClient", Method: "POST"},
	{Path: "/v1/merchant/shippingTemplate/getShippingTemplateById/:id", Description: "运费模板详情", ApiGroup: "shippingTemplateClient", Method: "GET"},
	...
	{Path: "/v1/merchant/product/getProductById/:id", Description: "商品详情", ApiGroup: "productClient", Method: "GET"},
	...
	{Path: "/v1/merchant/product/getProductReplyList", Description: "商品评论列表", ApiGroup: "productClientReply", Method: "POST"},
	...
	{Path: "/v1/merchant/user/getAdminList", Description: "管理员列表", ApiGroup: "user", Method: "POST"},
	...
	// 用户管理
	{Path: "/v1/merchant/cuser/getGeneralList", Description: "c用户列表", ApiGroup: "cuserClient", Method: "POST"},
	{Path: "/v1/merchant/cuser/getGeneralDetail/:id", Description: "c用户列表", ApiGroup: "cuserClient", Method: "GET"},
