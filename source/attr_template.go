...
var attrTemplates = []model.AttrTemplate{
	{TemplateName: "鞋类", TemplateValue: []byte(`[{"value":"\u989c\u8272","detail":["\u9ec4\u8272","\u7ea2\u8272"]},{"value":"\u5927\u5c0f","detail":["35","36","38"]}]`), SysTenancyId: 1},
	{TemplateName: "化妆品", TemplateValue: []byte(`[{"value":"\u96c5\u8bd7\u5170\u9edb","detail":["15","20"]},{"value":"\u5170\u853b","detail":["15","20"]}]`), SysTenancyId: 1},
	{TemplateName: "手机", TemplateValue: []byte(`[{"value":"\u989c\u8272","detail":["\u9ed1","\u94f6","\u91d1","\u767d","\u65e0\u8272"]}]`), SysTenancyId: 1},
}
